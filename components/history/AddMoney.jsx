...
const AddMoney = ({ addMoney2Function }) => {
  //
    ...
    <>
      <main className="mx-4">
        ...
        <div className="grid grid-flow-row-dense grid-cols-2 py-4  gap-4 items-center justify-center">
          <button className="bg-[#e3efee] py-4 sm:py-1 border-2 focus:border-green-300 border-dashed text-center text-[#32a693]  text-xl">
            +10
          </button>
          <button className="bg-[#e3efee] py-4 sm:py-1 border-2 focus:border-green-300 border-dashed text-center text-[#32a693]  text-xl">
            +50
